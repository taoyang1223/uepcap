...
var moduleDefinitions = []moduleDefinition{
	...
	},
	{
		...
		Items: []messageDefinition{
			...
			ngap("downlink-ran-status-transfer", "Downlink RAN Status Transfer", "7", "0"),
			ngap("handover-cancel", "Handover Cancel", "10", "0"),
			ngap("handover-cancel-acknowledge", "Handover Cancel Acknowledge", "10", "1"),
			ngap("handover-notify", "Handover Notify", "11", "0"),
			ngap("handover-required", "Handover Required", "12", "0"),
			ngap("handover-command", "Handover Command", "12", "1"),
			ngap("handover-preparation-failure", "Handover Preparation Failure", "12", "2"),
			ngap("handover-request", "Handover Request", "13", "0"),
			ngap("handover-request-acknowledge", "Handover Request Acknowledge", "13", "1"),
			ngap("handover-failure", "Handover Failure", "13", "2"),
			ngap("path-switch-request", "Path Switch Request", "25", "0"),
			ngap("path-switch-request-acknowledge", "Path Switch Request Acknowledge", "25", "1"),
			ngap("path-switch-request-failure", "Path Switch Request Failure", "25", "2"),
			ngap("uplink-ran-status-transfer", "Uplink RAN Status Transfer", "49", "0"),
		},
	},
	{
		Key:      "s1ap",
